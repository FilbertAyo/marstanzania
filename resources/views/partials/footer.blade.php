<footer class="bg-primary-dark-2 text-white">
    <div class="container py-20 lg:py-[100px]">
        <div class="row">
            <div class="col-12 order-first lg:col-4">
                <div class="w-full">
                    <a href="." class="inline-block mb-5">
                        <img src="{{ asset('assets/img/shortwlogo.png') }}" alt="" style="width: 200px;">
                    </a>
            ...
            <div class="col-6 lg:col-2">
                <div class="w-full">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="javascript:void(0)" class="mb-3 inline-block text-body-dark-11 hover:text-primary">
                                Home</a>
                        </li>
                        <li>
                            <a href="javascript:void(0)"
                                class="mb-3 inline-block text-body-dark-11 hover:text-primary">About us</a>
                        </li>
                        <li>
                            <a href="javascript:void(0)"
                                class="mb-3 inline-block text-body-dark-11 hover:text-primary">Services</a>
                        </li>
                        <li>
                            <a href="javascript:void(0)"
                                class="mb-3 inline-block text-body-dark-11 hover:text-primary">Terms of service</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-6 lg:col-2">
                <div class="w-full">
                    <h4 class="mb-9 text-lg font-semibold text-inherit">Our services</h4>
                    <ul>
                        <li>
                            <a href="javascript:void(0)"
                                class="mb-3 inline-block text-body-dark-11 hover:text-primary">e-commerce </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)"
                                class="mb-3 inline-block text-body-dark-11 hover:text-primary">Advanced Purchase</a>
                        </li>
                        <li>
                            <a href="javascript:void(0)"
                                class="mb-3 inline-block text-body-dark-11 hover:text-primary">Partnership</a>
                        </li>
                        <li>
                            <a href="javascript:void(0)"
                                class="mb-3 inline-block text-body-dark-11 hover:text-primary">Barter-agreement</a>
                        </li>
                    </ul>
                </div>
            </div>
